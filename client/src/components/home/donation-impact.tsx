        ...
        <div className="grid md:grid-cols-2">
          <div className="p-8 md:p-12 flex flex-col justify-center">
            ...
            <p className="relative italic text-lg text-neutral-dark mb-6 pl-6 donation-quote">
              "Your waste can be someone's treasure. Donate today and make a
              difference!"
            </p>
            <p className="text-neutral-dark mb-8">
              Every donated item finds its way to someone who truly needs it.
              From children in orphanages to elderly in care homes, your
              contributions create real impact.
            </p>
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div>
                <div className="text-2xl font-bold text-[#FFC107] mb-1">
                  82%
                </div>
                <div className="text-sm text-neutral-dark">
                  of donations matched within 48 hours
                </div>
              </div>
              <div>
                <div className="text-2xl font-bold text-[#FFC107] mb-1">
                ...
                <div className="text-sm text-neutral-dark">
                  items donated to organizations in need
                </div>
              </div>
            </div>
            <Link href="/auth">
