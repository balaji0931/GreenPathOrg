...
export function LeaderboardSection() {
  ...
  const { data: users, isLoading } = useQuery<LeaderboardUser[]>({
    ...
    queryFn: async ({ queryKey }) => {
      ...
      const response = await fetch(`/api/leaderboard?timeRange=${timeRangeValue}`);
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-dark max-w-2xl mx-auto">
            Recognizing our most active community members who are making a real difference
            through sustainable waste management and environmental activities.
          </p>
        </div>
        ...
        <Card className="mx-auto max-w-3xl shadow-md">
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-neutral-dark">{getTimeRangeLabel()}</span>
              </div>
            </div>
          ...
          <CardContent>
            {isLoading ? (
                    ...
                    <div className="flex-grow">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-neutral-dark capitalize">{user.role}</p>
                        </div>
                        <div className="text-right">
                          <span className="font-bold text-primary">{user.socialPoints}</span>
              ...
              <div className="text-center py-8 text-neutral-dark">No leaderboard data available.</div>
            )}
