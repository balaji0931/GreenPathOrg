      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl mb-8 opacity-90">
            Join our community-driven platform to manage waste responsibly, donate unused items, and participate in environmental initiatives.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/about">
              <Button variant="outline" className="px-6 py-3 bg-transparent border border-white text-white font-medium rounded-md hover:bg-white/10 transition">
                Learn More
              </Button>
            </Link>
          </div>
